 ...
 */
class Iplist extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    public function __construct(
        ...
        $this->setTemplate('system/config/button/iplist.phtml');
    }
    /**
     * Render button
     *
       ...
       $scopeCode = $valueScope[1];
        $this->addData(
            [
                ...
                'intern_url' => $originalData['button_url'],
